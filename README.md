...
1. [Create an app](https://api.slack.com/apps?new_app=1) ([Documentation](https://api.slack.com/slack-apps#creating_apps)). Add the App to a Workspace you will use for this lab.
If you don't have Workspace, create one [here](https://slack.com/create).
